...
<head runat="server">
    ...
    <style>
        ...
        * {
        ...
        .l7v2-tile-top, .l7v2-value, .l7v2-label, .l7v2-spark {
            position: relative;
            z-index: 2;
        }
        ...
        .lcp-nav-btn {
            ...
            .lcp-nav-btn:hover {
                background: #f5f2ff;
                transform: scale(1.06);
                box-shadow: 0 6px 14px rgba(76,42,143,0.15);
            }
        ...
        .lcp-month-card {
            ...
            .lcp-month-card:hover {
                transform: translateY(-2px);
                box-shadow: 0 10px 20px rgba(20,30,60,0.1);
            }
        ...
        .lcp-day {
            ...
            .lcp-day:hover {
                ...
                box-shadow: 0 8px 16px rgba(20,30,60,0.18);
                z-index: 3;
                border-color: transparent;
            }
        ...
        .lcp-day.lcp-cl {
            background: linear-gradient(135deg, #22d3ee, #0891b2);
            border-color: transparent;
            box-shadow: 0 2px 5px rgba(8,145,178,0.35);
        }

        .lcp-day.lcp-sl {
            background: linear-gradient(135deg, #c084fc, #9333ea);
            border-color: transparent;
            box-shadow: 0 2px 5px rgba(147,51,234,0.35);
        }

        .lcp-day.lcp-al {
            background: linear-gradient(135deg, #d4b96a, #b8973f);
            border-color: transparent;
            box-shadow: 0 2px 5px rgba(184,151,63,0.35);
        }
        ...
        .lcp-day.lcp-sl.lcp-today::after, .lcp-day.lcp-al.lcp-today::after {
            background: #fff;
        }
                    ...
                    <div class="card shadow">
                        <div class="card-header-custom section-header">
                            ...
                            <span class="section-count-badge"><i class="bi bi-people-fill me-1"></i>
                                <asp:Literal ID="litRecentCount" runat="server" Text="0" /></span>
                        </div>
                    ...
                    <div class="card shadow h-100 l7-compact l7v2-card">
                        <div class="card-header-custom section-header">
                            ...
                            <span class="section-count-badge"><i class="bi bi-clock-history me-1"></i>
                                <asp:Literal ID="litL7Range" runat="server" Text="Rolling 7-Day Window" /></span>
                        </div>
                        <div class="card-body p-3">
                    ...
                    <div class="card shadow h-100 status-compact">
                        ...
                        <div class="card-body p-3">
                            <div class="status-count-hero">
                                <span class="big-num">
                                    <asp:Literal ID="litStatusTotalCount" runat="server" Text="0" /></span>
                            ...
                            <div class="leavecal-toolbar">
                                <div class="leavecal-filters">
                                    ...
                                    <div class="leavecal-filter-group">
                                        ...
                                        <asp:DropDownList ID="ddlLeaveCalMonth" runat="server" CssClass="leavecal-filter-select"
                                            AutoPostBack="true" OnSelectedIndexChanged="ddlLeaveCalFilter_Changed">
