...
<head runat="server">
    ...
    <style>
        ...
        * {
        ...
        /* Silver */
        .leavecal-legend-dot.lc-ph {
            background: linear-gradient(135deg, #d4c887, #bdb76b);
        }
        ...
        .leavecal-legend-dot.lc-sl {
            background: linear-gradient(135deg, #ff9478, #ff6f52);
        }
        ...
        .leavecal-chip {
            ...
            .leavecal-chip.lc-ph {
                background: linear-gradient(135deg, #d4c887, #bdb76b); /* DarkKhaki */
                color: #1a2332;
                box-shadow: 0 4px 10px rgba(189, 183, 107, 0.4);
            }
            ...
            .leavecal-chip.lc-sl {
                background: linear-gradient(135deg, #ff9478, #ff6f52); /* Coral */
                color: #fff;
                box-shadow: 0 4px 10px rgba(255, 111, 82, 0.35);
            }

            .leavecal-chip.lc-al {
                background: linear-gradient(135deg, #ffe066, #ffd23f); /* Yellow */
                color: #4a3f00;
                        ...
                        <div class="card-body p-3 rl-body">
                            <div class="rl-tree">
                                ...
                                <div class="rl-card-row rl-manager-row rl-node">
                                    <div class="rl-avatar rl-avatar-manager">
                                        <i
                                ...
                                <div class="rl-you-badge rl-node">
                                ...
                                <div class="rl-reportees-wrap">
                                    <div class="rl-reportees-list" id="rlReporteesList">
                                        ...
                                        <div class="rl-card-row rl-reportee-row rl-node">
                                            ...
                                            <div class="rl-name">
                                                Employee No. 23961 <span
                                                    class="rl-indirect-star">*</span>
                                            </div>
                                        </div>
                                        <div class="rl-card-row rl-reportee-row rl-node">
                                ...
                                <div class="rl-scroll-hint">
                                    <i class="bi bi-chevron-down"></i>Scroll for
                                                more
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-12">
                    <div class="card shadow h-100 l7-compact leavecal-card">
                        ...
                        <div class="card-body p-3 leavecal-body">
                            ...
                            <div class="leavecal-toolbar">
                                <div class="leavecal-filters">
                                    <div class="leavecal-filter-group">
                                        ...
                                        <asp:DropDownList ID="ddlLeaveCalYear" runat="server" CssClass="leavecal-filter-select"
                                            AutoPostBack="true" OnSelectedIndexChanged="ddlLeaveCalFilter_Changed">
                                            <asp:ListItem Text="2022" Value="2022" Selected="True" />
                            ...
                            <div class="leavecal-scroll-hint">
                                <i class="bi bi-arrow-left-right"></i>Scroll
                                            to see all days
                            </div>
